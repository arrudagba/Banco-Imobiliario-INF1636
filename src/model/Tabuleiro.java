...
public class Tabuleiro {
    ...
    private void inicializarTabuleiro() {
    	casas.add(new CasaInicio(1, "PARTIDA"));
        ...
        casas.add(new CasaPropriedade(5, "Companhia Ferroviária", 200));
        casas.add(new CasaPropriedade(6, "Av. Brigadeiro Faria Lima", 240));
        casas.add(new CasaPropriedade(7, "Companhia de Viação", 200));
        ...
        casas.add(new CasaPropriedade(14, "Companhia de Táxi", 150));
        ...
        casas.add(new CasaImposto(21, "Imposto de Renda", 200));

        casas.add(new CasaPropriedade(22, "Companhia de Navegação", 150));
        ...
        casas.add(new CasaPropriedade(28, "Companhia de Aviação", 200));
        casas.add(new CasaPropriedade(29, "Av. Vieira Souto", 320));
        casas.add(new CasaPropriedade(30, "Av. Atlântica", 300));
        casas.add(new CasaPropriedade(31, "Companhia de Táxi Aéreo", 200));
